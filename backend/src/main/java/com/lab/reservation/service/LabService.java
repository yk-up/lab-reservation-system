...
import com.lab.reservation.dto.LabAvailableSlotResponse;
...
public class LabService {
     ...
     */
    public List<LabAvailableSlotResponse> getAvailableSlots(Long labId, LocalDate date) {
        ...
        List<LabAvailableSlotResponse> slots = new ArrayList<>();
        ...
        while (cursor.isBefore(endOfDay)) {
            ...
            slots.add(new LabAvailableSlotResponse(cursor.toString(), slotEnd.toString(), occupied));
            cursor = slotEnd;
        }
        return slots;
    }
